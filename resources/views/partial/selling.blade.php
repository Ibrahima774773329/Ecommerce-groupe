        ...
        <div class="row">
            <div class="col-md-3 col-12 col-sm-6 col-lg-3">
                ...
                <div class="card-body mx-3">
                    <h6 class="card-title">The north coat</h6>
                        <div class="d-flex">
                            <p class="text-danger py-3 fw-bold">$260 <span class="text-black py-3 mx-2 text-decoration-line-through fw-bold">$360</span></p>
                        </div>
            ...
            <div class="col-md-3 col-12 col-sm-6 col-lg-3">
                ...
                <div class="card-body mx-3">
                    ...
                    <div class="d-flex">
                        <p class="text-danger py-3 fw-bold">$160 <span class="text-black py-3 mx-2 text-decoration-line-through fw-bold">$170</span></p>
                    </div>
                    <div class="stars mx-2 py-2 d-flex">
                        <i class="bi bi-star-fill"></i>
                        <i class="bi bi-star-fill"></i>
            ...
            <div class="col-md-3 col-12 col-sm-6 col-lg-3">
                ...
                <div class="card-body mx-3">
                    ...
                    <div class="d-flex">
                        <p class="text-danger py-3 fw-bold">$360</p>
                    </div>
                    <div class="stars mx-2 py-2 d-flex">
                        <i class="bi bi-star-fill"></i>
                        <i class="bi bi-star-fill"></i>
